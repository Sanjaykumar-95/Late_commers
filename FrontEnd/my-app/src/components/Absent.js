...
function Present() {
  ...
  function handleFilter(event) {
    ...
    const filteredData = data.filter(
      (student) => student.RollNo.toLowerCase().includes(filterText) && student.status === 0
    );
        ...
        <div className='card'>
          ...
          <div className='card-body'>
            ...
            <div class="row" style={{ display: "flex", flexWrap: "wrap" }}>
              ...
              <div className='col-md-4' style={{ textAlign: "center" }}><h1 style={{ fontSize: "35px" }}>Absentes</h1></div>
